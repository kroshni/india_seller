...
// Import the client utility
import { getClient } from '../src/lib/db/cassandra.js';

const businessTypes = [
  'Manufacturing', 'Retail', 'Services', 'Technology', 'Food & Beverage',
  'Apparel', 'Healthcare', 'Education', 'Agriculture', 'Construction'
];
