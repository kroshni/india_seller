...
"[project]/src/lib/api-client/category-client.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
// Utility to ensure properly formatted URL
function ensureValidUrl(url) {
    // Make sure there are no double slashes except for the protocol
...
async function getCategoryById(id) {
    try {
        ...
        const url = ensureValidUrl(`/api/categories/${id}`);
        ...
        if (!response.ok) {
            const errorData = await response.json();
            console.error('Error response from category API:', errorData);
...
async function updateCategoryStatus(id, status) {
    try {
        ...
        const url = ensureValidUrl(`/api/categories/${id}/status`);
        ...
        if (!response.ok) {
            throw new Error(responseData.error || 'Failed to update category status');
        }
        return true;
    } catch (error) {
...
"[project]/src/components/categories/CategoryStatusToggle.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname, k: __turbopack_refresh__, m: module } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>CategoryStatusToggle)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2f$category$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api-client/category-client.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
;
function CategoryStatusToggle({ id, initialStatus, onStatusChange }) {
    _s();
    ...
    const toggleStatus = async ()=>{
        ...
        try {
            ...
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2f$category$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCategoryStatus"])(id, newStatus);
            if (success) {
                setStatus(newStatus);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        `,
          ...
          `
                    ...
                    fileName: "[project]/src/components/categories/CategoryStatusToggle.tsx",
                    lineNumber: 57,
                    columnNumber: 9
                }, this)
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                ...
                children: isUpdating ? 'Updating...' : status
            }, void 0, false, {
                fileName: "[project]/src/components/categories/CategoryStatusToggle.tsx",
                lineNumber: 64,
                columnNumber: 7
...
_s(CategoryStatusToggle, "FCM8Mk8wvAz4fytMy3YRfCLDf9c=");
_c = CategoryStatusToggle;
var _c;
__turbopack_context__.k.register(_c, "CategoryStatusToggle");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
;
;
function CategoryForm({ categoryId, initialData, onSuccess, onCancel }) {
    _s();
    const isEditing = !!categoryId;
    console.log(`CategoryForm initialized - Mode: ${isEditing ? 'Edit' : 'Create'}`);
    if (isEditing) {
    ...
    const handleGenerateSlug = ()=>{
        if (formData.name) {
            const slug = formData.name.toLowerCase().replace(/[^a-z0-9\s-]/g, '') // Remove special characters
    ...
    const handleSubmit = async (e)=>{
        ...
        console.log(`Submitting form in ${isEditing ? 'edit' : 'create'} mode`);
        console.log('Form data to submit:', formData);
        try {
            if (isEditing && categoryId) {
                // Update existing category
                console.log(`Updating category ${categoryId}...`);
                const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2f$category$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateCategory"])(categoryId, formData);
                if (success) {
                    console.log('Category updated successfully');
                    onSuccess(categoryId);
                } else {
                    console.error('Category update failed - server returned false');
                    setErrors({
                ...
                const newCategoryId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2f$category$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createCategory"])(formData);
                if (newCategoryId) {
                    console.log(`Category created successfully with ID: ${newCategoryId}`);
                    onSuccess(newCategoryId);
                } else {
                    console.error('Category creation failed - no ID returned');
                    setErrors({
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                ...
                                className: `block w-full rounded-md border ${errors.name ? 'border-red-300' : 'border-gray-300'} shadow-sm py-2 px-3 focus:border-blue-500 focus:ring-blue-500`
                            }, void 0, false, {
                                fileName: "[project]/src/components/categories/CategoryForm.tsx",
                                lineNumber: 165,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                ...
                                value: formData.slug,
                                onChange: handleChange,
                                className: `block w-full rounded-l-md border ${errors.slug ? 'border-red-300' : 'border-gray-300'} shadow-sm py-2 px-3 focus:border-blue-500 focus:ring-blue-500`
                            }, void 0, false, {
                                fileName: "[project]/src/components/categories/CategoryForm.tsx",
                                lineNumber: 186,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("textarea", {
                                ...
                                onChange: handleChange,
                                className: `block w-full rounded-md border ${errors.description ? 'border-red-300' : 'border-gray-300'} shadow-sm py-2 px-3 focus:border-blue-500 focus:ring-blue-500`
                            }, void 0, false, {
                                fileName: "[project]/src/components/categories/CategoryForm.tsx",
                                lineNumber: 214,
                                columnNumber: 11
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                            ...
                            onChange: handleChange,
                            className: "block w-full rounded-md border border-gray-300 shadow-sm py-2 px-3 focus:border-blue-500 focus:ring-blue-500",
                            children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        ...
                        children: isSubmitting ? isEditing ? 'Updating...' : 'Creating...' : isEditing ? 'Update Category' : 'Create Category'
                    }, void 0, false, {
                        fileName: "[project]/src/components/categories/CategoryForm.tsx",
                        lineNumber: 256,
                        columnNumber: 9
...
_s(CategoryForm, "gvcKpIFFYtlZ57obGYDVXYvygYM=");
_c = CategoryForm;
var _c;
...
'use client';
;
function ConfirmationModal({ isOpen, onClose, onConfirm, title, message, confirmText = 'Confirm', cancelText = 'Cancel', confirmButtonClass = 'bg-red-600 hover:bg-red-700', isLoading = false }) {
    _s();
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "mt-2",
                                        children: typeof message === 'string' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    type: "button",
                                    className: `w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm ${confirmButtonClass} ${isLoading ? 'opacity-75 cursor-not-allowed' : ''}`,
                                    onClick: onConfirm,
                                    disabled: isLoading,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2f$category$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/api-client/category-client.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$categories$2f$CategoryStatusToggle$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/categories/CategoryStatusToggle.tsx [app-client] (ecmascript)");
...
function CategoriesPage() {
        ...
        "CategoriesPage.useEffect": ()=>{
            ...
            if (searchQuery) {
                ...
                result = result.filter({
                    "CategoriesPage.useEffect": (category)=>category.name.toLowerCase().includes(lowerCaseQuery)
                }["CategoriesPage.useEffect"]);
            }
            // Apply sorting
            result.sort({
                "CategoriesPage.useEffect": (a, b)=>{
                    if (sortKey === 'name') {
    ...
    const fetchCategories = async ()=>{
        ...
        try {
            ...
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2f$category$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategories"])();
    ...
    const handleEditClick = async (id)=>{
        ...
        try {
            console.log(`Fetching category ${id} for editing...`);
            const { category } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2f$category$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategoryById"])(id);
            console.log('Category data for editing:', category);
            if (category) {
    ...
    const handleDeleteConfirm = async ()=>{
        if (!selectedCategoryId) {
            console.error('No category ID selected for deletion');
            return;
        }
        setIsProcessing(true);
        try {
            console.log(`Attempting to delete category ${selectedCategoryId}`);
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2f$category$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteCategory"])(selectedCategoryId);
            if (success) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Manage product categories for your store"
                            }, void 0, false, {
                                fileName: "[project]/src/app/dashboard/categories/page.tsx",
                                lineNumber: 206,
                                columnNumber: 11
                ...
                children: [
                    ...
                    isLoading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            ...
                            children: searchQuery ? 'No categories match your search criteria.' : 'No categories found. Start by adding a new category.'
                        }, void 0, false, {
                            fileName: "[project]/src/app/dashboard/categories/page.tsx",
                            lineNumber: 274,
                            columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    ...
                                    children: filteredCategories.map((category)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "px-6 py-4 whitespace-nowrap",
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$categories$2f$CategoryStatusToggle$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                                        id: category.id,
            ...
            showEditModal && selectedCategory && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "fixed inset-0 z-10 overflow-y-auto",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0",
                    children: [
...
_s(CategoriesPage, "w4KFTQdtQIQ1s57KBTTC0N0XwDA=");
_c = CategoriesPage;
var _c;
...
//# sourceMappingURL=src_7511eea5._.js.map