...
function CategoryAddModal({ isOpen, onClose, onCategoryAdded }) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            onCategoryAdded(responseData.category);
            // Reset form
            setName('');
            setSlug('');
            setDescription('');
...
;
;
function CategoryTable({ categories, isLoading, onStatusUpdate, onDeleteClick }) {
    _s();
    ...
    const handleDeleteConfirm = async ()=>{
        ...
        try {
            ...
            try {
                ...
                console.log('No JSON response body for delete operation');
            }
...
//# sourceMappingURL=src_17dd1ce2._.js.map