...
async function updateCategory(id, data) {
    ...
    if (shouldUseMockData()) {
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            const categories = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadCategories"])();
            const localIndex = categories.findIndex((c)=>c.id === id);
            if (localIndex !== -1) {
                categories[localIndex] = updatedCategory;
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveCategories"])(categories);
            }
        }
...
async function deleteCategory(id) {
    ...
    if (shouldUseMockData()) {
        ...
        if ("TURBOPACK compile-time truthy", 1) {
            ...
            const localIndex = categories.findIndex((c)=>c.id === id);
            if (localIndex !== -1) {
                categories.splice(localIndex, 1);
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$storage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveCategories"])(categories);
            }
        }
        return true;
...
//# sourceMappingURL=src_e188a126._.js.map