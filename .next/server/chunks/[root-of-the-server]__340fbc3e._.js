...
async function GET(request) {
    try {
        ...
        if (searchParams.has('sortOrder')) filters.sortOrder = searchParams.get('sortOrder') || undefined;
        // Get customers with filters
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$customer$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllCustomers"])(filters);
...
async function POST(request) {
    try {
        ...
        // Create customer
        const customerId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$customer$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createCustomer"])(data);
        if (!customerId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PATCH(request) {
    try {
        ...
        // Perform bulk update
        const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$customer$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["bulkUpdateCustomers"])(bulkUpdateInput);
        if (!success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function DELETE(request) {
    try {
        ...
        const results = await Promise.all(data.customerIds.map(async (id)=>{
            const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$customer$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteCustomer"])(id);
            return {
                id,
                success
            };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__340fbc3e._.js.map