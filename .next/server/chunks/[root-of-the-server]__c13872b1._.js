...
"[project]/.next-internal/server/app/api/sellers/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/sellers/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const sellerData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSellerById"])(id);
        if (!sellerData) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(sellerData);
    } catch (error) {
...
async function PUT(request, { params }) {
    try {
        ...
        const existing = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSellerById"])(id);
        if (!existing) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Seller not found'
            }, {
        ...
        const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateSeller"])(id, data);
        if (!success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
async function PATCH(request, { params }) {
    try {
        ...
        if (data.status !== undefined) {
            ...
            success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateSellerStatus"])(id, data.status);
            ...
            success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateSellerKycStatus"])(id, data.kycStatus);
            ...
            success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateSellerTopScorer"])(id, topScorerValue);
        } else {
            // If none of the specific fields are provided, treat as a partial update
            success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateSeller"])(id, data);
        }
        if (!success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Failed to update seller'
...
async function DELETE(request, { params }) {
    try {
        ...
        const success = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteSeller"])(id);
        if (!success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c13872b1._.js.map