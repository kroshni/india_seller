...
"[project]/.next-internal/server/app/api/products/unassigned/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/lib/local-storage.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/services/product-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$local$2d$storage$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/local-storage.ts [app-route] (ecmascript)");
;
;
;
...
function shouldUseMockData() {
    ...
    const connected = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cassandra$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isDbConnected"])();
...
"[project]/src/app/api/products/unassigned/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$product$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/product-service.ts [app-route] (ecmascript)");
...
async function GET(request) {
    try {
        ...
        const assignedProductIds = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllAssignedProductIds"])();
        ...
        // 2. Get all products
        const allProductsResponse = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$product$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllProducts"])({
            limit: 1000
        });
        const allProducts = allProductsResponse.products;
        console.log(`Found ${allProducts.length} total products`);
        // 3. Filter to find unassigned products
        const unassignedProductIds = allProducts.filter((product)=>!assignedProductIds.includes(product.id)).map((product)=>product.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f00f7bbe._.js.map