...
"[project]/.next-internal/server/app/api/sellers/featured/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/sellers/featured/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const { sellers: topTierSellers } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllSellers"])({
            minTopScorer: 70,
            status: 'Active',
            kycStatus: 'Verified',
            limit: 4,
        ...
        const { sellers: secondaryTierSellers } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllSellers"])({
            minTopScorer: 50,
            status: 'Active',
            kycStatus: 'Verified',
            limit: 4,
        ...
        if (secondaryTierSellers.length > 0) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                sellers: secondaryTierSellers
            });
        }
        // If still not enough, just get any active sellers
        console.log('Not enough secondary tier sellers, trying any active sellers...');
        const { sellers: anySellers } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$seller$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllSellers"])({
            status: 'Active',
            limit: 4,
            sortBy: 'isTopScorer',
            sortOrder: 'desc'
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d0cabe30._.js.map