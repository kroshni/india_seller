    ...
    if (client === null && ("TURBOPACK compile-time value", "development") === 'development') {
        try {
            ...
            if (username && password) {
                options.authProvider = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cassandra$2d$driver$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["auth"].PlainTextAuthProvider(username, password);
            }
            client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cassandra$2d$driver$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Client"](options);
...
const USE_MOCK_DATA = ("TURBOPACK compile-time value", "development") === 'development' || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$cassandra$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isDbConnected"])();
...
async function GET(request) {
    try {
        const categories = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$category$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllCategories"])();
...
async function POST(request) {
    try {
        ...
        // Create the category
        const category = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$category$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createCategory"])(categoryInput);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            category
        }, {
            status: 201
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8a13c907._.js.map